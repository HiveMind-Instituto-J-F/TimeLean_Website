...
<div class="container">
    <h1>🗑️ Deletar Plano</h1>

    <div class="info">
        <strong>Nota:</strong> Digite o ID do plano que deseja remover.
    </div>

    <form method="POST" action="<%= request.getContextPath() %>/delete-plan">
        <div class="form-group">
            <label for="id">ID do Plano *</label>
            <input type="number" id="id" name="id" placeholder="Ex: 1" min="1" required>
        </div>
        <button type="submit">Deletar Plano</button>
    </form>

...
<body>
    ...
    <main>
        ...
        <section> <!-- Desabilitar o display -->
            ...
            <div id="filter-bar" class="inter">
                ...
                <div>
                    <a class="inter" href="${pageContext.request.contextPath}/pages/create/payment.jsp">Cadastrar novo pagamento</a>
                </div>
            </div>
    ...
    <footer class="inter-thin">
        ...
        <nav id="redirects" class="inter navbar">
            <a href="${pageContext.request.contextPath}/pages/aboutUs.html">Quem somos</a>
            <a href="${pageContext.request.contextPath}/index.html">Home</a>
            <a href="${pageContext.request.contextPath}/pages/login.jsp">Gestão de trabalhadores</a>
        </nav>
        <nav class="medias">

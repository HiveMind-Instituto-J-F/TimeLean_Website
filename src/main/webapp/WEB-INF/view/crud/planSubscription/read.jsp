...
<main>
    ...
    <section> <!-- Desabilitar o display -->
        ...
        <div id="filter-bar" class="inter">
            ...
            <div>
                <a class="inter" href="${pageContext.request.contextPath}/pages/create/planSubscription.jsp">Cadastrar
                    nova inserção</a>
            </div>
        </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="actions">
                            ...
                            <form class="delete" action="${pageContext.request.contextPath}/plan_subscription/delete" method="post">
                                <button type="submit">
                                    <input type="hidden" name="id" value="<%= ps.getId() %>">

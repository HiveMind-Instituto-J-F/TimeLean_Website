            ...
            <div class="input-div input-password">
                ...
                <div>
                    ...
                    <button name="toggle" type="button">
                        <img id="open" src="${pageContext.request.contextPath}/img/icons/ui/eye%20(open).png" alt="mostrar senha">
                        <img id="closed" src="${pageContext.request.contextPath}/img/icons/ui/eye%20(closed).png" alt="ocultar senha">
                    </button>
                </div>
            </div>
            <%

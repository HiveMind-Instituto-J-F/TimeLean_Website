    ...
    <header class="blur">
        ...
        <div id="redirects">
            <nav class="inter navbar">
                ...
                <a href="${pageContext.request.contextPath}/html/aboutUs.html" target="_blank">Quem somos</a>
...
<main>
    ...
    <aside id="crud-sidebar" class="sidebar inter-thin">
        ...
        <div id="summary">
            ...
            <a href="${pageContext.request.contextPath}/html/aboutUs.html"><h3>Sobre nós</h3></a>
            <a href="${pageContext.request.contextPath}/html/email/send.jsp" target="_blank"><h3>Entrar em contato</h3></a>
        </div>
    </aside>
                            ...
                            <div class="actions">
                                <form action="show" method="get">
                                    <button type="button" class="see toggle-visibility">
                                        <img class="eye open" src="${pageContext.request.contextPath}/img/icons/ui/eye (open).png" alt="Mostrar">
                                        <img class="eye closed" src="${pageContext.request.contextPath}/img/icons/ui/eye (closed).png" alt="Ocultar">
                                    </button>
                                </form>
                            ...
                            <div class="actions">
                                ...
                                <form class="delete" style="opacity: 0; cursor: default;">
                                    ...
                                    <button style="opacity: 0; cursor: default;" type="submit">
                                        <img style="opacity: 0; cursor: default;" src="${pageContext.request.contextPath}/img/icons/ui/trash (black).png" alt="Deletar">
                                    </button>
                                </form>
                            </div>
                        </td>

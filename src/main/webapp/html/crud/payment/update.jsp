...
<%
    ...
    // Aqui você buscaria os dados do pagamento no banco
...
<div class="container">
    ...
    <form action="/HivemindWeb_war/create-paymount" method="post">
        ...
        <div class="form-group">
            ...
            <input type="number" name="number_installments" required min="1" max="12">
        </div>

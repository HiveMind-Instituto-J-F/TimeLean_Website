...
public class Login extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        if(paramPlantCnpj == null || paramPlantCnpj.isEmpty()) {throw new IllegalArgumentException("Values Is Null, Value: 'cnpj'");}

        String paramResponsibleCpf = req.getParameter("plant-responsible-cpf");
        if(paramResponsibleCpf == null || paramResponsibleCpf.isEmpty()) {throw new IllegalArgumentException("Values Is Null, Value: 'ResponsibleCpf'");}

        String paramResponsibleLoginEmail = req.getParameter("plant-responsible-login-email");
        if(paramResponsibleLoginEmail == null || paramResponsibleLoginEmail.isEmpty()) {throw new IllegalArgumentException("Values Is Null, Value: 'ResponsibleLoginEmail'");}

        String paramResponsibleLoginPassword = req.getParameter("plant-responsible-login-password");
        if(paramResponsibleLoginPassword == null || paramResponsibleLoginPassword.isEmpty()) {throw new IllegalArgumentException("Values Is Null, Value: 'ResponsibleLoginPassword'");}
